...
namespace GalleryApp.Droid
{
    public class PhotoImporter : IPhotoImporter
    {
        ...
        public bool ContinueWithPermission(bool granted)
        {
            ...
            var cursor = MainActivity.Current.ContentResolver.Query(imageUri, null, MediaStore.Images.ImageColumns.MimeType + "=? or " + MediaStore.Images.ImageColumns.MimeType + "=?", new string[] { "image/jpeg", "image/png", "image/jpg" }, MediaStore.Images.ImageColumns.DateModified);
